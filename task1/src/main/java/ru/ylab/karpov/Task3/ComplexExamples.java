...
public class ComplexExamples {
    ...
    public static void main(String[] args) {
        ...
        Map<String, Long> person = Arrays.stream(RAW_DATA)
                .distinct()
                .filter(Objects::nonNull)
                .filter(i -> i.getName() !=null)
                .sorted(new PersonComparator())
                .collect(Collectors.groupingBy(Person::getName,Collectors.counting()));
                 person.forEach((key, value) -> System.out.println("Key: " + key + "\nValue: " + value));
                System.out.println();
        /*
        Task2
        ...
        System.out.println(fuzzySearch(null,"carthweel")); //false
        System.out.println(fuzzySearch("carghfkg",null)); //false
